...
class PositivesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create positive" do
    assert_difference('Positive.count') do
      post positives_url, params: { positive: { lat: @positive.lat, long: @positive.long, name: @positive.name, point: @positive.point } }
    end
  ...
  test "should update positive" do
    patch positive_url(@positive), params: { positive: { lat: @positive.lat, long: @positive.long, name: @positive.name, point: @positive.point } }
